...
export const DashboardPageContent = () => {
  ...
  const {
    data: categories,
    isPending: isEventCategoriesLoading,
          ...
          >
            ...
            <div className="relative p-6 z-10">
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="flex items-center text-sm/5 text-gray-600">
                  <BarChart3 className="size-4 mr-2 text-brand-500" />
              ...
              <div className="flex items-center justify-between mt-4 group">
                ...
                >
                  View All{" "}
                  <ArrowRight className="size-4 group-hover:translate-x-[2px] transition-all" />
                </Link>
                <Button
                  variant="ghost"
                  size="sm"
