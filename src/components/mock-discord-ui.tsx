    ...
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-gray text-white rounded-lg overflow-hidden shadow-xl">
      ...
      <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-gray rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-discord-brand cursor-not-allowed"
          >
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          ...
          <div className="px-2 mb-4">
            ...
            <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-pointer">
              ...
              />
              <span className="font-medium">PingPal</span>
            </div>
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                ...
                >
                  <div className="size-8 rounded-full bg-discord-gray mr-3"></div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            ...
            <p className="font-semibold text-white">PingPal</p>
          </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444b] rounded-lg p-1">
            ...
            <input
              readOnly
              type="text"
              placeholder="Message @pingpal"
              className="flex-1 bg-transparent py-2.5 px-1 text-white placeholder-[#858a92] focus:outline-none cursor-not-allowed"
            />
            <div className="flex items-center space-x-3 mx-3 text-[#b9bbbe]">
              <Gift className="size-5 hover:text-white cursor-not-allowed hiddene sm:block" />
              <Sticker className="size-5 hover:text-white cursor-not-allowed hiddene sm:block" />
              <Smile className="size-5 hover:text-white cursor-not-allowed hiddene sm:block" />
            </div>
          </div>
        </div>
      </div>
